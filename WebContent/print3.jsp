...
<%
	...
	try
	{
		...
		PreparedStatement stmt1=con.prepareStatement("select * from register where  name=?");
		stmt1.setString(1,name);
		ResultSet rs=stmt1.executeQuery();
		if(rs.next())
		accno=rs.getString(14);
		rs.close();
		stmt1.close();
		PreparedStatement stmt2=con.prepareStatement("select * from recurringaccount where tdate between ? and ? and accno=?");
		stmt2.setDate(1,dt1);
		stmt2.setDate(2,dt2);
