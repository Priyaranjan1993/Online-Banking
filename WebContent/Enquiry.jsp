...
<%
String name1=request.getParameter("actno");

	try
	{
		Class.forName("oracle.jdbc.driver.OracleDriver");
		Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","bank","bank");
		PreparedStatement stmt=con.prepareStatement("select * from REPORTS where ACCNO=?");
...
<% 
		while(rs.next())
		{
			...
			out.print("<tr><td>"+name1+"</td><td>"+rs.getString(1)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(6)+"</td><td>"+rs.getString(3)+"</td></tr>");
		}
		rs.close();
		stmt.close();
		con.close();
